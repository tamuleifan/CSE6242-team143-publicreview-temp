...
python zillow.py New-York-NY cheapest 20

output:
properties-New_York_NYcheapest CSV file, the top 20 pages of rental info displayed on zillow
...
if __name__=="__main__":
    ...
    with open("properties-%s.csv"%(location+sort),'wb')as csvfile:
